...
if (native == null) {
  try {
    native = require('bindings')('segfault-handler');
  } catch (e) {
...
if (native == null) {
  try {
    ...
    native = require(__dirname + '/build/Release/segfault-handler');
  } catch(e) {
...
if (native == null) {
  try {
    native = require(__dirname + '/build/default/segfault-handler');
  } catch(e) {
